 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.semcolor.impl.PersonsImpl#getPersons <em>Persons</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PersonsImpl extends MinimalEObjectImpl.Container implements Persons
{
  ...
  {
    return SemcolorPackage.Literals.PERSONS;
  }
  ...
  public EList<Person> getPersons()
  {
    if (persons == null)
    {
      persons = new EObjectContainmentEList<Person>(Person.class, this, SemcolorPackage.PERSONS__PERSONS);
    }
    return persons;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SemcolorPackage.PERSONS__PERSONS:
