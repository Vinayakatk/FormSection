...
public class ExtensionGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class ModelElements extends AbstractParserRuleElementFinder {
		...
		private final CrossReference cMetamodelEPackageCrossReference_3_0 = (CrossReference)cMetamodelAssignment_3.eContents().get(0);
		private final RuleCall cMetamodelEPackageIDTerminalRuleCall_3_0_1 = (RuleCall)cMetamodelEPackageCrossReference_3_0.eContents().get(1);
		...
		private final RuleCall cExtensionsExtensionParserRuleCall_7_0 = (RuleCall)cExtensionsAssignment_7.eContents().get(0);
		...
		//[ecore::EPackage]
		public CrossReference getMetamodelEPackageCrossReference_3_0() { return cMetamodelEPackageCrossReference_3_0; }

		//ID
		public RuleCall getMetamodelEPackageIDTerminalRuleCall_3_0_1() { return cMetamodelEPackageIDTerminalRuleCall_3_0_1; }
		...
		//Extension
		public RuleCall getExtensionsExtensionParserRuleCall_7_0() { return cExtensionsExtensionParserRuleCall_7_0; }
	...
	public class RefineElements extends AbstractParserRuleElementFinder {
		...
		private final CrossReference cPrefixEClassCrossReference_3_0 = (CrossReference)cPrefixAssignment_3.eContents().get(0);
		private final RuleCall cPrefixEClassIDTerminalRuleCall_3_0_1 = (RuleCall)cPrefixEClassCrossReference_3_0.eContents().get(1);
		...
		//[ecore::EClass]
		public CrossReference getPrefixEClassCrossReference_3_0() { return cPrefixEClassCrossReference_3_0; }

		//ID
		public RuleCall getPrefixEClassIDTerminalRuleCall_3_0_1() { return cPrefixEClassIDTerminalRuleCall_3_0_1; }
	...
	public class GeneralizeElements extends AbstractParserRuleElementFinder {
		...
		private final CrossReference cPrefixEClassCrossReference_6_1_0 = (CrossReference)cPrefixAssignment_6_1.eContents().get(0);
		private final RuleCall cPrefixEClassIDTerminalRuleCall_6_1_0_1 = (RuleCall)cPrefixEClassCrossReference_6_1_0.eContents().get(1);
		...
		//Generalize:
		//	"add class" classNew=ID "supertyping" prefix+=[ecore::EClass] "." class+=ID ("," prefix+=[ecore::EClass] "."
		//	class+=ID)*;
		@Override public ParserRule getRule() { return rule; }
		...
		//[ecore::EClass]
		public CrossReference getPrefixEClassCrossReference_6_1_0() { return cPrefixEClassCrossReference_6_1_0; }

		//ID
		public RuleCall getPrefixEClassIDTerminalRuleCall_6_1_0_1() { return cPrefixEClassIDTerminalRuleCall_6_1_0_1; }
	...
	public class ModifyClassElements extends AbstractParserRuleElementFinder {
		...
		private final CrossReference cPrefixEClassCrossReference_1_0 = (CrossReference)cPrefixAssignment_1.eContents().get(0);
		private final RuleCall cPrefixEClassIDTerminalRuleCall_1_0_1 = (RuleCall)cPrefixEClassCrossReference_1_0.eContents().get(1);
		...
		//ModifyClass:
		//	"modify class" prefix=[ecore::EClass] "." class=ID "{" modifyOperators+=ModifyOperator* "}";
		@Override public ParserRule getRule() { return rule; }
		...
		//[ecore::EClass]
		public CrossReference getPrefixEClassCrossReference_1_0() { return cPrefixEClassCrossReference_1_0; }

		//ID
		public RuleCall getPrefixEClassIDTerminalRuleCall_1_0_1() { return cPrefixEClassIDTerminalRuleCall_1_0_1; }
