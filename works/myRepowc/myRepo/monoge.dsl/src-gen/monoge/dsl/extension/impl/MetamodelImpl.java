 ...
 * </p>
 * <ul>
 *   <li>{@link monoge.dsl.extension.impl.MetamodelImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MetamodelImpl extends MinimalEObjectImpl.Container implements Metamodel
{
  ...
  {
    return ExtensionPackage.Literals.METAMODEL;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ExtensionPackage.METAMODEL__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ExtensionPackage.METAMODEL__NAME:
        return getName();
    }
