...
public class ModifyClassImpl extends ExtensionImpl implements ModifyClass
{
  ...
  public EClass getPrefix()
  {
    if (prefix != null && prefix.eIsProxy())
    {
      ...
      prefix = (EClass)eResolveProxy(oldPrefix);
      if (prefix != oldPrefix)
      {
   ...
   * @generated
   */
  public void setPrefix(EClass newPrefix)
  {
    EClass oldPrefix = prefix;
    prefix = newPrefix;
    if (eNotificationRequired())
