...
public class GeneralizeImpl extends ExtensionImpl implements Generalize
{
   ...
   * @generated
   */
  public EList<EClass> getPrefix()
  {
    if (prefix == null)
    {
      prefix = new EObjectResolvingEList<EClass>(EClass.class, this, ExtensionPackage.GENERALIZE__PREFIX);
    }
    return prefix;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case ExtensionPackage.GENERALIZE__PREFIX:
        getPrefix().clear();
        getPrefix().addAll((Collection<? extends EClass>)newValue);
        return;
      case ExtensionPackage.GENERALIZE__CLASS:
        getClass_().clear();
