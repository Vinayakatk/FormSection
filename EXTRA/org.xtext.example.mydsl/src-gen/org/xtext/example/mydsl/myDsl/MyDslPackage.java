...
public interface MyDslPackage extends EPackage
{
  ...
  /**
   * The meta object id for the '{@link org.xtext.example.mydsl.myDsl.impl.TypeAImpl <em>Type A</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see org.xtext.example.mydsl.myDsl.impl.TypeAImpl
   * @see org.xtext.example.mydsl.myDsl.impl.MyDslPackageImpl#getTypeA()
   * @generated
   */
  int TYPE_A = 2;
  ...
  /**
   * The meta object id for the '{@link org.xtext.example.mydsl.myDsl.impl.TypeBImpl <em>Type B</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see org.xtext.example.mydsl.myDsl.impl.TypeBImpl
   * @see org.xtext.example.mydsl.myDsl.impl.MyDslPackageImpl#getTypeB()
   * @generated
   */
  int TYPE_B = 3;
   ...
   * @ordered
   */
  int TYPE_B__FULLNAME = TYPE_A_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int TYPE_B_FEATURE_COUNT = TYPE_A_FEATURE_COUNT + 1;
  ...
  /**
   * Returns the meta object for class '{@link org.xtext.example.mydsl.myDsl.TypeA <em>Type A</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Type A</em>'.
   * @see org.xtext.example.mydsl.myDsl.TypeA
   * @generated
   */
  EClass getTypeA();

  /**
   * Returns the meta object for the attribute '{@link org.xtext.example.mydsl.myDsl.TypeA#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Name</em>'.
   * @see org.xtext.example.mydsl.myDsl.TypeA#getName()
   * @see #getTypeA()
   * @generated
   */
  EAttribute getTypeA_Name();

  /**
   * Returns the meta object for class '{@link org.xtext.example.mydsl.myDsl.TypeB <em>Type B</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Type B</em>'.
   * @see org.xtext.example.mydsl.myDsl.TypeB
   * @generated
   */
  EClass getTypeB();

  /**
   * Returns the meta object for the attribute '{@link org.xtext.example.mydsl.myDsl.TypeB#getFullname <em>Fullname</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Fullname</em>'.
   * @see org.xtext.example.mydsl.myDsl.TypeB#getFullname()
   * @see #getTypeB()
   * @generated
   */
  EAttribute getTypeB_Fullname();
  ...
  interface Literals
  {
    ...
    /**
     * The meta object literal for the '{@link org.xtext.example.mydsl.myDsl.impl.TypeAImpl <em>Type A</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see org.xtext.example.mydsl.myDsl.impl.TypeAImpl
     * @see org.xtext.example.mydsl.myDsl.impl.MyDslPackageImpl#getTypeA()
     ...
     * @generated
     */
    EAttribute TYPE_A__NAME = eINSTANCE.getTypeA_Name();

    /**
     * The meta object literal for the '{@link org.xtext.example.mydsl.myDsl.impl.TypeBImpl <em>Type B</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see org.xtext.example.mydsl.myDsl.impl.TypeBImpl
     * @see org.xtext.example.mydsl.myDsl.impl.MyDslPackageImpl#getTypeB()
     ...
     * @generated
     */
    EAttribute TYPE_B__FULLNAME = eINSTANCE.getTypeB_Fullname();
