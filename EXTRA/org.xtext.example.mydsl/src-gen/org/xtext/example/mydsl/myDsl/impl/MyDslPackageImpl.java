...
import org.xtext.example.mydsl.myDsl.TypeA;
...
public class MyDslPackageImpl extends EPackageImpl implements MyDslPackage
{
   ...
   * @generated
   */
  public EAttribute getTypeA_Name()
  {
   ...
   * @generated
   */
  public EAttribute getTypeB_Fullname()
  {
  ...
  public void createPackageContents()
  {
    ...
    createEAttribute(typeAEClass, TYPE_A__NAME);

    typeBEClass = createEClass(TYPE_B);
    createEAttribute(typeBEClass, TYPE_B__FULLNAME);
  }
  ...
  public void initializePackageContents()
  {
    ...
    typeBEClass.getESuperTypes().add(this.getTypeA());
    ...
    initEAttribute(getTypeA_Name(), ecorePackage.getEString(), "name", null, 0, 1, TypeA.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(typeBEClass, TypeB.class, "TypeB", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getTypeB_Fullname(), ecorePackage.getEString(), "fullname", null, 0, 1, TypeB.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
