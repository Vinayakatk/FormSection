 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl2.myDsl.impl.CardinalityImpl#getLowerBound <em>Lower Bound</em>}</li>
 *   <li>{@link org.xtext.example.mydsl2.myDsl.impl.CardinalityImpl#getUpperBound <em>Upper Bound</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CardinalityImpl extends MinimalEObjectImpl.Container implements Cardinality
{
  ...
  {
    return MyDslPackage.Literals.CARDINALITY;
  }
  ...
  public void setLowerBound(int newLowerBound)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.CARDINALITY__LOWER_BOUND, oldLowerBound, lowerBound));
  }
  ...
  public void setUpperBound(Integer newUpperBound)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.CARDINALITY__UPPER_BOUND, oldUpperBound, upperBound));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyDslPackage.CARDINALITY__LOWER_BOUND:
        return getLowerBound();
      case MyDslPackage.CARDINALITY__UPPER_BOUND:
