...
import org.xtext.example.myStateMachines.myStateMachines.MyStateMachinesFactory;
 ...
 * @generated
 */
public class MyStateMachinesPackageImpl extends EPackageImpl implements MyStateMachinesPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.myStateMachines.myStateMachines.MyStateMachinesPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private MyStateMachinesPackageImpl()
  {
    super(eNS_URI, MyStateMachinesFactory.eINSTANCE);
  }
   ...
   * 
   * <p>This method is used to initialize {@link MyStateMachinesPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static MyStateMachinesPackage init()
  {
    if (isInited) return (MyStateMachinesPackage)EPackage.Registry.INSTANCE.getEPackage(MyStateMachinesPackage.eNS_URI);

    // Obtain or create and register package
    MyStateMachinesPackageImpl theMyStateMachinesPackage = (MyStateMachinesPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof MyStateMachinesPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new MyStateMachinesPackageImpl());

    isInited = true;

    // Create package meta-data objects
    theMyStateMachinesPackage.createPackageContents();

    // Initialize created meta-data
    theMyStateMachinesPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theMyStateMachinesPackage.freeze();

  
    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(MyStateMachinesPackage.eNS_URI, theMyStateMachinesPackage);
    return theMyStateMachinesPackage;
  }
   ...
   * @generated
   */
  public EAttribute getState_Actions()
  {
   ...
   * @generated
   */
  public EReference getState_Refinement()
  {
   ...
   * @generated
   */
  public MyStateMachinesFactory getMyStateMachinesFactory()
  {
    return (MyStateMachinesFactory)getEFactoryInstance();
  }
  ...
  public void createPackageContents()
  {
    ...
    createEAttribute(stateEClass, STATE__ACTIONS);
    createEReference(stateEClass, STATE__REFINEMENT);
  ...
  public void initializePackageContents()
  {
    ...
    initEAttribute(getState_Actions(), ecorePackage.getEString(), "actions", null, 0, -1, State.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getState_Refinement(), this.getStatemachine(), null, "refinement", null, 0, 1, State.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
