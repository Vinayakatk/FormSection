		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMainAccess().getNameAssignment_2(), "rule__Main__NameAssignment_2");
					put(grammarAccess.getMainAccess().getImportsAssignment_3(), "rule__Main__ImportsAssignment_3");
					put(grammarAccess.getMainAccess().getSAssignment_4(), "rule__Main__SAssignment_4");
					...
					put(grammarAccess.getFollowUpAccess().getNextAssignment_3(), "rule__FollowUp__NextAssignment_3");
