...
public class EXTLibraryPackageImpl extends EPackageImpl implements EXTLibraryPackage
{
  ...
  /**
	 ...
	 * @generated
	 */
	public EReference getLibrary_Con() {
  ...
  /**
	 ...
	 * @generated
	 */
	public EReference getConnection_Tar() {
  ...
  public void createPackageContents()
  {
		...
		createEReference(libraryEClass, LIBRARY__CON);
		...
		createEReference(connectionEClass, CONNECTION__TAR);
  ...
  public void initializePackageContents()
  {
		...
		initEReference(getLibrary_Con(), this.getConnection(), null, "con", null, 0, -1, Library.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		...
		initEReference(getConnection_Tar(), this.getBook(), null, "tar", null, 0, 1, Connection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEReference(getConnection_Src(), this.getBook(), null, "src", null, 0, 1, Connection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
