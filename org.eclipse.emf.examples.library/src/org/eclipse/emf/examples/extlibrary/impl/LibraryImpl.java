 ...
 *   <li>{@link org.eclipse.emf.examples.extlibrary.impl.LibraryImpl#getCon <em>Con</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LibraryImpl extends EObjectImpl implements Library
{
  ...
  /**
	 ...
	 * @ordered
	 */
	protected EList<Connection> con;
  ...
  /**
	 ...
	 * @generated
	 */
	public EList<Connection> getCon() {
		if (con == null) {
			con = new EObjectContainmentEList.Resolving<Connection>(Connection.class, this, EXTLibraryPackage.LIBRARY__CON);
		}
		return con;
	}
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
		switch (featureID) {
			...
			case EXTLibraryPackage.LIBRARY__CON:
  ...
  public void eSet(int featureID, Object newValue)
  {
		switch (featureID) {
			...
			case EXTLibraryPackage.LIBRARY__CON:
				getCon().clear();
				getCon().addAll((Collection<? extends Connection>)newValue);
				return;
		}
