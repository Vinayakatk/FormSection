...
public class SurveyPackageImpl extends EPackageImpl implements SurveyPackage
{
  ...
  public void createPackageContents()
  {
    ...
    createEReference(mainEClass, MAIN__S);
  ...
  public void initializePackageContents()
  {
    ...
    guardEClass.getESuperTypes().add(this.getFollowUp());
    ...
    initEReference(getMain_S(), this.getSurvey(), null, "s", null, 0, -1, Main.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getFollowUp_Next(), this.getSurvey(), null, "next", null, 0, 1, FollowUp.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
